...
function Postform() {
  ...
  useEffect(()=>{
    console.log(url)
    if(url){
      fetch("https://instabackend-kxq3.onrender.com/addpost",{
        method:"Post",
        headers: {
 ...
 const postimage=()=>{
  ...
  data.append("upload_preset","ashutosh")
  data.append("cloude_name","dkpfflome")
  fetch("https://api.cloudinary.com/v1_1/dkpfflome/image/upload",{
    method:"Post",
    body:data
  })
  .then(res=>
  ...
  return (
    ...
    <Button variant="primary" className='upload' onClick={()=>{
     ...
     {toggle &&  <h1 className='loader'>fill details..</h1>}
     {toggle2 &&  <h1 className='loader2'>loading....</h1>}
